...
void Game::initGame() {
	...
	app.window = SDL_CreateWindow("Galatic Skyfire", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
	if (!app.window) {
		cout << "Could not create window : " << SDL_GetError() << endl;
		exit(-1);
	}
	SDL_Surface* sf = IMG_Load("logo.png");
	...
	app.playing = false;
	app.background = loadTexture("background.png");
	...
	enemyBulletTexture = loadTexture("alienBullet.png");
	enemyTexture = loadTexture("quai.png");

	music = Mix_LoadMUS("backgroundMusic.ogg");
	explosionSound = Mix_LoadWAV("enemyExplosion.ogg");
	playerExplosionSound = Mix_LoadWAV("explosionSound.wav");
	buttonSound = Mix_LoadWAV("buttonSound.mp3");
	bulletSound = Mix_LoadWAV("bulletSound.ogg");
	powerupSound = Mix_LoadWAV("earnPowerUp.ogg");

	explosionTexture = loadTexture("explosion.png");
	font = TTF_OpenFont("Goldeneye.ttf", 28);
	titleFont = TTF_OpenFont("Ghost.ttf", 90);
	Mix_PlayMusic(music, -1);

	shipModel[0] = loadTexture("maybay1.png");
	shipModel[1] = loadTexture("maybay2.png");
	shipModel[2] = loadTexture("maybay3.png");
	shipModel[3] = loadTexture("maybay4.png");
	shipModel[4] = loadTexture("maybay5.png");

	bulletModel[0] = loadTexture("white.png");
	bulletModel[1] = loadTexture("yellow-white.png");
	bulletModel[2] = loadTexture("blue.png");
	bulletModel[3] = loadTexture("green.png");
	bulletModel[4] = loadTexture("rship.png");

	enemyBoss[0] = loadTexture("boss1.png");
	enemyBoss[1] = loadTexture("boss2.png");
	enemyBoss[2] = loadTexture("boss3.png");

	bossBullet[0] = loadTexture("enemyBoss1.png");
	bossBullet[1] = loadTexture("enemyBoss2.png");
	bossBullet[2] = loadTexture("enemyBoss3.png");

	//Button
	Buttons[0] = loadTexture("start1.png");
	Buttons[2] = loadTexture("guide_1.png");
	Buttons[4] = loadTexture("exit_1.png");
	Buttons[6] = loadTexture("left.png");
	Buttons[8] = loadTexture("right.png");
	Buttons[10] = loadTexture("back_1.png");
	Buttons[12] = loadTexture("menu_1.png");
	Buttons[14] = loadTexture("playagain_1.png");
	Buttons[16] = loadTexture("play_1.png");


	Buttons[1] = loadTexture("start2.png");
	Buttons[3] = loadTexture("guide_2.png");
	Buttons[5] = loadTexture("exit_2.png");
	Buttons[7] = loadTexture("hoverleft.png");
	Buttons[9] = loadTexture("hoverright.png");
	Buttons[11] = loadTexture("back_2.png");
	Buttons[13] = loadTexture("menu_2.png");
	Buttons[15] = loadTexture("playagain_2.png");
	Buttons[17] = loadTexture("play_2.png");
	...
	pauseIcon = loadTexture("pauseIcon.png");
	lock = loadTexture("lock.png");
	guide = loadTexture("guide.png");
	healthbar = loadTexture("healthbar.png");
	bar = loadTexture("bar.png");
	powerUp1 = loadTexture("LP.png");
	powerUp2 = loadTexture("enhanceATK.png");
	...
	if (player.getHealth() > 0) {
		...
		if (player.Fire() == true && player.getReload() == 0) {
			...
			if (player.getEnhance() > 0) {
				...
				playerBullet.setX(player.getX());
				playerBullet.setY(player.getY() + 1000);
				Bullets.push_back(playerBullet);
			}
